...
class EnhancedSP500Predictor:
    ...
    def _apply_sector_rotation(self, features: pd.DataFrame):
        ...
        if 'Market_Cap_Billions' in self.company_info.columns and 'Sector' in self.company_info.columns:
            ...
            # Apply sector rotation based on volatility only (removed bull_market dependency)
...
if __name__ == "__main__":
    """
    Enhanced S&P 500 LSTM Predictor with Custom Biases (v2.0.0)
    ====================================================
    ...
    3. Low representation boost: Used for defensive sectors during high volatility
    ...
    Changes in v2.0.0:
    - Removed bull_market feature completely
    - Removed negative_streak feature and related calculations
    - Removed diversification_factor feature
    - Simplified apply_growth_bias method
    - Removed adjust_for_negative_streaks method
    - Removed negative_streak_threshold from config
    - Simplified sector rotation to use only volatility
    """
